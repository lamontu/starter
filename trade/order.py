...
#{'result': 'error', 'reason': 'InsufficientFunds', 'message': "Failed to place buy order on symbol 'BTCUSD' for price $3,633.00 and quantity 1 BTC due to insufficient funds"}